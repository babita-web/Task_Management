            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <h6 class="card-title"> Total Tasks: <?php
                        ...
                        <h6 class="card-title"> <a href="{{ url('create-task') }}" class="btn btn-primary float-right">Add Task</a></h6>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        Filter:
                        {{--<a href="/tasks">All</a> |
                        <a href="/?status/{{ $tasks->status=5 }}">Archived</a> |
                        <a href="/?status/{{ $tasks->status=1 }}">Active</a> |
